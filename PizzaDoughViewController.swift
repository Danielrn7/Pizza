...
class PizzaDoughViewController: UIViewController,AKRadioButtonsControllerDelegate
{
   var pizza: Pizza = Pizza()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        pizza.dough = (radioButtons[radioButtonsController.selectedIndex].titleLabel?.text)!
